...
#
#
master_account_id = '504412577470'

profile = '504412577470_AWSAdministratorAccess'
region  =  'eu-west-1'
...
def get_active_access_keys(account_id, account_name):
    ...
    for org in org_iterator:
      for account in track(org['Accounts']):
        if account['Id'] != master_account_id:
          get_active_access_keys(account_id = account['Id'], account_name=account['Name'])
    console.print(table)
